...
export const PHONE = "+91 96893 95868";

export const EMAIL = "mahapurushpackersandmovers08@gmail.com";
export const WHATSAPP = "919689395868";
...
export const SERVICES: Service[] = [
  ...
  {
    id: 'post-move-cleaning',
    title: 'Post-Move Cleaning',
    shortDesc: 'Professional room cleaning after relocation to ensure your space is fresh, dust-free, and ready to use.',
    fullDesc: 'After the move is complete, our post-move cleaning service helps you settle into a neat, usable space. We handle dust removal, surface cleaning, and room preparation so your home or office feels ready from day one.',
    icon: <Sparkles className="w-8 h-8" />,
    image: 'https://images.unsplash.com/photo-1581578731548-c64695cc6952?auto=format&fit=crop&q=80&w=800',
    benefits: ['Dust-free rooms', 'Fresh ready-to-use space', 'Post-shift cleanup support', 'Suitable for homes and offices'],
    process: ['Walkthrough assessment', 'Dust and debris removal', 'Surface and room cleaning', 'Final quality check'],
    faqs: [
      { q: 'Is cleaning available right after unloading?', a: 'Yes, we can schedule the cleaning service immediately after relocation based on availability.' }
    ]
  }
];
